...
public class Crf extends ContainerItem
{
	...
	// Iterate over CrfVersion children of this Crf object
	while (crf_versions_itr.hasNext()) {  
	    ...
	    // Iterating over Sections in this CrfVersion
	...
	// Add this new version to the Crf
	addItem(new_version);
    }
	...
	for (Item version : getItems()) {
	    ...
	    System.out.println("  CrfVersion: " + version.name());
    ...
    public int type() {	return Item.CRF; }

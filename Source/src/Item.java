...
public abstract class Item
{
    ...
    // SETTERS
    protected void parentContainer(ContainerItem parent) { parent_container = parent; }
    public void name(String name) 
    { 
	this.name = name; 
	xml_safe_name = Helper.createXMLTagName(name);
    }
    public void xmlName(String name) { this.xml_safe_name = name; }
    ...
    public String xmlName() { return xml_safe_name; }
    protected ContainerItem parentContainer() { return parent_container; }
    public String description() { return description; }
    public String xmlDescription() { return Helper.cleanse(description); }

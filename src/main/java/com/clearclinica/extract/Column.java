...
public class Column extends Item {
	...
	*/
    ...
    public ArrayList<String> subjects() {
        ...
        System.out.print("com.clearclinica.extract.Column: " + name() + "  contains: ");
    ...
    public void writeToMapFile(BufferedWriter file, String section_name) {
        ...
        // TODO: Debugging
	/*
	System.out.println("com.clearclinica.extract.Section name: " + section_name);
	...
	*/
        ...
        try {
            file.write("    <COLUMN name=\"" + xmlName() + "\">");
            file.newLine();
            file.write("      <PATH syntax=\"XPath\">/OCEXPORT/TABLE/" + section_name + "/" + xmlName() + "</PATH>");
            file.newLine();
            file.write("      <DESCRIPTION>" + xmlDescription() + "</DESCRIPTION>");
            file.newLine();
            file.write("      <TYPE>" + fmtType() + "</TYPE>");
            file.newLine();
            file.write("      <DATATYPE>" + datatype() + "</DATATYPE>");
            file.newLine();

            if (datatype.equals("string")) {
                file.write("      <LENGTH>" + length + "</LENGTH>");
                file.newLine();
            }
            ...
            if (formats != null) {
                ...
                if (label != null) {
                    file.write("      <FORMAT>" + label.getLabel() + "</FORMAT>");
                    file.newLine();
                } else {
                    ...
                    if (format().equals("CRFDATE") || format().equals("BESTNULL")) {
                        ...
                        if (GF.spss) {
                            ...
                            if (format().equals("CRFDATE")) {
                                file.write("      <FORMAT width=\"9\">DATE</FORMAT>");
                                file.newLine();
                            } else {
                                file.write("      <FORMAT ndec=\"2\" width=\"10\">BEST</FORMAT>");
                                file.newLine();
                            }
                        } else {
                            file.write("      <FORMAT width=\"10\">" + format() + "</FORMAT>");
                            file.newLine();
                        }

                    } else {
                        if (GF.spss && format().equals("IS8601DT")) {
                            file.write("      <FORMAT width=\"14\">DATETIME</FORMAT>");
                            file.newLine();
                        } else {
                            file.write("      <FORMAT>" + format() + "</FORMAT>");
                            file.newLine();
                        }
                    }
                }
                ...
                file.write("      <FORMAT>" + format_string + "</FORMAT>");
                file.newLine();
            ...
            if (datatype().equals("date")) {
                file.write("      <INFORMAT width=\"10\">" + format() + "</INFORMAT>");
                file.newLine();
            } else if (datatype().equals("date")) {
                file.write("      <INFORMAT width=\"10\">IS8601DA</INFORMAT>");
                file.newLine();
            } else if (datatype().equals("datetime")) {
                file.write("      <INFORMAT width=\"19\">" + format() + "</INFORMAT>");
                file.newLine();
            } else if (datatype().equals("integer") || datatype().equals("double")) {
                file.write("      <INFORMAT>" + format() + "</INFORMAT>");
                file.newLine();
            }

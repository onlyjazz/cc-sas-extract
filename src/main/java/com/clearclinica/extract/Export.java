...
class Export {
    ...
    public void runExport() {
        ...
        main_study.createUniqueSectionNames();    // Step through the com.clearclinica.extract.Item structure and create unique xml section names for the export
    ...
    public void getData(BufferedWriter file) {
        ...
        while (sections_itr.hasNext()) {
            ...
            //System.out.print(" com.clearclinica.extract.Section: " + section.xmlName() + "   ==> ");
            //	    section.printIDS();
            //System.out.println();
    ...
    public void getStudyMetadata() {
	    ...
	    /* Step through each crf found in above query and get all sections that belong to it */
            while (res.next()) {
                ...
                // Create the com.clearclinica.extract.Crf and com.clearclinica.extract.CrfVersion objects
		...
		/* Create and populate com.clearclinica.extract.Section Objects for each section found in the given crf version. */
                while (sections.next()) {
                    ...
                    if (DEBUG) {
                        System.out.println(" com.clearclinica.extract.Section (" + section_id + "): " + label);
                    }
    ...
    private void writeMapFile() {
        if (ui.isGenerateMapFile()) {
            ...
            try {
                ...
                mapFile.write("<SXLEMAP description=\"Maps OpenClinica Data com.clearclinica.extract.Export to SAS data structures.\" name=\"OCEXPORT\" version=\"1.2\">");
                mapFile.newLine();
    ...
    private void createSubjectTable() {
        ...
        subjectTable.description("com.clearclinica.extract.Study Subject Details");

        Section subject_section = new Section("-1", "subjects", "com.clearclinica.extract.Study Subjects", Section.NO_HEADER);
        subjectTable.addItem(subject_section);

        // Add the columns to the subject table
        subject_section.addItem(new Column("sid", "com.clearclinica.extract.Study subject id", "text", -1, "ST"));
        subject_section.addItem(new Column("secondary_label", "com.clearclinica.extract.Study subject secondary label", "text", -1, "ST"));
    ...
    public void createDiscrepancyTable() {
        ...
        discrepancy_section.addItem(new Column("study", "com.clearclinica.extract.Study", "text", -1, "ST"));
        discrepancy_section.addItem(new Column("sid", "com.clearclinica.extract.Study subject ID", "text", -1, "ST"));
        ...
        discrepancy_section.addItem(new Column("study_event", "com.clearclinica.extract.Study event", "text", -1, "ST"));
        ...
        discrepancy_section.addItem(new Column("item_value", "com.clearclinica.extract.Item value causing discrepancy", "text", -1, "ST"));
        discrepancy_section.addItem(new Column("column_name", "com.clearclinica.extract.Column name from crf", "text", -1, "ST"));
    ...
    public void createSubjectEventTable() {
        ...
        // Add the columns to the discrepancy table
        se_section.addItem(new Column("study", "com.clearclinica.extract.Study", "text", -1, "ST"));
        se_section.addItem(new Column("study_site", "The site that the subject is enrolled in", "text", -1, "ST"));
        se_section.addItem(new Column("sid", "com.clearclinica.extract.Study subject ID", "text", -1, "ST"));
        se_section.addItem(new Column("study_event", "com.clearclinica.extract.Study event", "text", -1, "ST"));
    ...
    public void getDataItems(Iterator section_ids_itr, ContainerItem section) {
	    ...
	    */
		    ...
		    */
			...
			/*
			if (event_crf_id == null || event_crf_id.isEmpty()) {
	    ...
	    /* Get all the item_name's metadata which will make up the columns in the crf_version for this section */
            ...
            while (res.next()) {
                ...
                if (repeat_max > 1) {
                    ...
                    // com.clearclinica.extract.Group item metadata to add
                    String id = "<group>" + group_id;
                    Group group = (Group) section.getItemWithID(id);
                    if (group == null) {
                        // This com.clearclinica.extract.Item does not exist yet
    ...
    public void getCrfMetadata() {
	    ...
	    /* All label and option data has been pulled from the database.
	       Put these labels and options into the com.clearclinica.extract.Format object */

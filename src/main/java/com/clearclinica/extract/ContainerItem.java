...
public class ContainerItem extends Item {
    ...
    // Add an com.clearclinica.extract.Item object to this Container Object. Items added here represent metadata.
    ...
    /* Returns the number of times a com.clearclinica.extract.Group item has repeat data in it. Important for
        ...
        while (itr.hasNext()) {
            ...
            while (remaining_sections_itr.hasNext()) {
                ...
                if (current_section.xmlName().equals(compare_section.xmlName())) {
                    // com.clearclinica.extract.Section name is duplicate
                    attempts++;
	...
	/* Iterate through all this com.clearclinica.extract.ContainerItem object's contained items and
    ...
    // Get all com.clearclinica.extract.ColumnData that is a child of this com.clearclinica.extract.ContainerItem object

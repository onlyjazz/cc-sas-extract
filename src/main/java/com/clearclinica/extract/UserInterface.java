...
class UserInterface {
    ...
    public boolean isGenerateMapFile() {
        return !nomap;
    }

    public boolean isGenerateSPSS() {
        return spss;
    }
    ...
    public void showOutputDetails() {
        System.out.println("----------------------------------------");
        System.out.println("             com.clearclinica.extract.Export Output:             ");
        System.out.println("----------------------------------------");
    ...
    public String getExportFileName() {
        if (xmlFile == null) {
            System.out.print("\nEnter com.clearclinica.extract.Export file name (default: derived from study): ");
            xmlFile = readLine();
    ...
    private void Test(String[] args) {
        ...
        System.out.println("com.clearclinica.extract.Export File Name: " + params.get(1));

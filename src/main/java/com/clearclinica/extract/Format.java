...
/**
 * com.clearclinica.extract.Format
 * <p>
...
public class Format {
    ...
    // Both HashMap's below refer to same com.clearclinica.extract.Label object
    ...
    public void addLabelMapping(String crf_version_id, String dtype, String label, String options, String values) {
        ...
        if (DEBUG) {
            System.out.println("In com.clearclinica.extract.Format.addLabelMapping:");
        ...
        if (lm == null) {
            if (DEBUG) {
                System.out.println("Could not find label in the collection of com.clearclinica.extract.LabelManager's with name: " + label + "\nCreating new label for this item.");
            }
        ...
        // Pass these options and values to the label manager and store the com.clearclinica.extract.Label object
    ...
    public void writeToMapFile(BufferedWriter file) {
        try {
            ...
            file.write("  <TABLE name=\"fmtlib\">");
            file.newLine();

            file.write("    <TABLE-PATH syntax=\"XPath\">/OCEXPORT/TABLE/fmtlib</TABLE-PATH>");
            file.newLine();
            file.write("    <COLUMN name=\"FMTNAME\">");
            file.newLine();
            file.write("      <PATH syntax=\"XPath\">/OCEXPORT/TABLE/fmtlib/FMTNAME</PATH>");
            file.newLine();
            file.write("      <TYPE>character</TYPE>");
            file.newLine();
            file.write("      <DATATYPE>string</DATATYPE>");
            file.newLine();
            file.write("      <LENGTH>" + fmtname_length + "</LENGTH>");
            file.newLine();
            file.write("    </COLUMN>");
            file.newLine();

            file.write("    <COLUMN name=\"START\">");
            file.newLine();
            file.write("      <PATH syntax=\"XPath\">/OCEXPORT/TABLE/fmtlib/START</PATH>");
            file.newLine();
            file.write("      <TYPE>character</TYPE>");
            file.newLine();
            file.write("      <DATATYPE>string</DATATYPE>");
            file.newLine();
            file.write("      <LENGTH>" + start_length + "</LENGTH>");
            file.newLine();
            file.write("    </COLUMN>");
            file.newLine();

            file.write("    <COLUMN name=\"LABEL\">");
            file.newLine();
            file.write("      <PATH syntax=\"XPath\">/OCEXPORT/TABLE/fmtlib/LABEL</PATH>");
            file.newLine();
            file.write("      <TYPE>character</TYPE>");
            file.newLine();
            file.write("      <DATATYPE>string</DATATYPE>");
            file.newLine();
            file.write("      <LENGTH>" + label_length + "</LENGTH>");
            file.newLine();
            file.write("    </COLUMN>");
            file.newLine();
            ...
            file.newLine();
            file.write("      <PATH syntax=\"XPath\">/OCEXPORT/TABLE/fmtlib/TYPE</PATH>");
            file.newLine();
            file.write("      <TYPE>character</TYPE>");
            file.newLine();
            file.write("      <DATATYPE>string</DATATYPE>");
            file.newLine();
            file.write("      <LENGTH>1</LENGTH>");
            file.newLine();
            file.write("    </COLUMN>");
            file.newLine();

            file.write("    <COLUMN name=\"HLO\">");
            file.newLine();
            file.write("      <PATH syntax=\"XPath\">/OCEXPORT/TABLE/fmtlib/HLO</PATH>");
            file.newLine();
            file.write("      <TYPE>character</TYPE>");
            file.newLine();
            file.write("      <DATATYPE>string</DATATYPE>");
            file.newLine();
            file.write("      <LENGTH>2</LENGTH>");
            file.newLine();
            file.write("    </COLUMN>");
            file.newLine();
            file.write("  </TABLE>");
    ...
    public void writeToXMLFile(BufferedWriter file) {
        try {
            ...
            if (SPSS) {
                ...
                //com.clearclinica.extract.Label.writeStandardNullFormats(file, "DATE9", "N", "DATE");
            } else {
                Label.writeStandardNullFormats(file, "CRFDATE", "I", "DATE");

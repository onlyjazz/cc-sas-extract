	...
	*/
    ...
    public boolean contains(String options, String values) {
        ...
        if (size != mapping.size()) {
            if (DEBUG) {
                System.out.println("com.clearclinica.extract.Label.java: Not same 1");
            }
            return false;
        }
        ...
        for (int i = 0; i < opt.length; i++) {
            ...
            if ((opt[i].length() > 0) && (val[i].length() > 0)) {
                ...
                if (v == null) {
                    ...
                    if (DEBUG) {
                        System.out.println("com.clearclinica.extract.Label.java: Not same 2");
                    }
                    return false;
                }
                ...
                if (!v.equals(val[i].trim())) {
                    ...
                    if (DEBUG) {
                        System.out.println("com.clearclinica.extract.Label.java: Not same 3");
    ...
    public static void writeStandardNullFormats(BufferedWriter file, String FMTNAME, String TYPE, String dtype) {
        try {
            ...
            if (TYPE.equals("I")) {
                file.write("    <fmtlib>");
                file.newLine();
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>NA</START>");
                file.newLine();
                file.write("      <LABEL>.A</LABEL>");
                file.newLine();
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>NASK</START>");
                file.newLine();
                file.write("      <LABEL>.D</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>UNK</START>");
                file.newLine();
                file.write("      <LABEL>.U</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>NI</START>");
                file.newLine();
                file.write("      <LABEL>.I</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>ASKU</START>");
                file.newLine();
                file.write("      <LABEL>.K</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>OTH</START>");
                file.newLine();
                file.write("      <LABEL>.O</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>NP</START>");
                file.newLine();
                file.write("      <LABEL>.P</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                if (dtype.equals("INT") || dtype.equals("REAL")) {
                    ...
                    file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                    file.newLine();
                    file.write("      <START>**OTHER**</START>");
                    file.newLine();
                    file.write("      <LABEL>BEST10.</LABEL>");
                    file.newLine();
                    file.write("      <TYPE>" + TYPE + "</TYPE>");
                    file.newLine();
                    file.write("      <HLO>OF</HLO>");
                    file.newLine();
                    file.write("    </fmtlib>");
                    file.newLine();
                    ...
                    file.write("      <START>**OTHER**</START>");
                    file.newLine();
                    file.write("      <LABEL>IS8601DA</LABEL>");
                    file.newLine();
                    file.write("      <TYPE>" + TYPE + "</TYPE>");
                    file.newLine();
                    file.write("      <HLO>OF</HLO>");
                    ...
                    file.write("      <START>**OTHER**</START>");
                    file.newLine();
                    file.write("      <LABEL>mmddyy10.</LABEL>");
                    file.newLine();
                    file.write("      <TYPE>" + TYPE + "</TYPE>");
                    file.newLine();
                    file.write("      <HLO>OF</HLO>");
            ...
            // Swap the order of START and LABEL
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>.A</START>");
                file.newLine();
                file.write("      <LABEL>NA</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>.D</START>");
                file.newLine();
                file.write("      <LABEL>NASK</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>.U</START>");
                file.newLine();
                file.write("      <LABEL>UNK</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>.I</START>");
                file.newLine();
                file.write("      <LABEL>NI</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>.K</START>");
                file.newLine();
                file.write("      <LABEL>ASKU</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>.O</START>");
                file.newLine();
                file.write("      <LABEL>OTH</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
                ...
                file.write("      <FMTNAME>" + FMTNAME + "</FMTNAME>");
                file.newLine();
                file.write("      <START>.P</START>");
                file.newLine();
                file.write("      <LABEL>NP</LABEL>");
                file.newLine();
                file.write("      <TYPE>" + TYPE + "</TYPE>");
                file.newLine();
                file.write("    </fmtlib>");
            ...
            try {
                ...
                if (label_type.equals("C")) {
                    while (i.hasNext()) {
                        ...
                        file.write("    <fmtlib>");
                        file.newLine();
                        file.write("      <FMTNAME>" + label + "</FMTNAME>");
                        file.newLine();
                        file.write("      <START>" + key + "</START>");
                        file.newLine();
                        file.write("      <LABEL>" + mapping.get(key) + "</LABEL>");
                        file.newLine();
                        file.write("      <TYPE>C</TYPE>");
                        file.newLine();
                        file.write("    </fmtlib>");
                        file.newLine();
                        ...
                        file.write("      <FMTNAME>" + label + "</FMTNAME>");
                        file.newLine();
                        file.write("      <START>" + mapping.get(key) + "</START>");
                        file.newLine();
                        file.write("      <LABEL>" + key + "</LABEL>");
                        file.newLine();
                        file.write("      <TYPE>J</TYPE>");
                        file.newLine();
                        file.write("    </fmtlib>");
                        file.newLine();
                    }
    ...
    public void print() {
        System.out.println("com.clearclinica.extract.Label: " + "==>" + label + "<==");
        System.out.println("Options: " + "==>" + options + "<==");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("com.clearclinica.extract.Format Width is: " + width);
    }
}